...
|client_address_parts |object|     client delivery address components; it's null when order is pickup; can contain the following components: <br> street <br> bloc <br> intercom <br> more_address - in case extended address is not enabled <br> zipcode <br> city <br> full_address - legacy orders
