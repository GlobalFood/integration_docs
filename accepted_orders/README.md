...
|type_id          |integer or null|  id of the original menu item or promotion used to create the order item; it's null for 'tip'; for 'delivery_fee' it is the id of the delivery_zone or null for orders outside the delivery zones; for service fees it is the id of the service_fee_* in the system; for cash_discount it is the id of the service_fee_subtotal item that it discounts|
